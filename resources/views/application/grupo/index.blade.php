<x-layouts.app :title="__('Lista de Grupos')">
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-4 space-y-4">
        ...
        <div class="flex flex-wrap gap-4 mb-4">
            ...
            <form action="{{ route('grupos.deleted-index') }}" method="GET">
                @csrf
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 max-h-[70vh] overflow-y-auto">
                        <form class="space-y-4" action="{{ route('grupos.store') }}" method="POST">
                            @csrf
                            <div>
                                <label for="descripcion" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Sigla del Grupo</label>
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <caption class="p-5 text-lg font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                ...
                <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">
                    Todos los grupos que se encuentran disponibles actualmente.
                </p>
            </caption>
            ...
            <tbody>
                ...
                <tr id="row-{{ $grupo->id }}" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                    ...
                    <td class="px-6 py-4">
                        ...
                        <form method="POST" action="{{ route('grupos.update', $grupo->id) }}" class="form-editar hidden">
                            @csrf
                            @method('PUT')
                    ...
                    <td class="px-6 py-4 text-right">
                        ...
                        <form method="POST" action="{{ route('grupos.destroy', $grupo->id) }}" class="inline-block" onsubmit="return confirm('¿Estás seguro de eliminar esta asignatura?');">
                            @csrf
                            @method('DELETE')
